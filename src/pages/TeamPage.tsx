          ...
          <div className="mb-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {executiveLeadership.members.map((member, memberIndex) => (
                <ScrollAnimation key={memberIndex} animation="slideUp" delay={memberIndex * 100}>
                  <HoverCard tiltIntensity={3}>
                    <div className="group bg-gray-900/50 border border-gray-800 hover:border-primary-vibrant/50 rounded-xl p-6 transition-all hover:-translate-y-2">
              ...
              {departments.map((department, index) => (
                <ScrollAnimation key={index} animation="slideUp" delay={index * 100}>
                  <HoverCard tiltIntensity={2}>
                    <div className="bg-gray-900/50 border border-gray-800 hover:border-primary-vibrant/50 rounded-xl p-6 transition-all hover:-translate-y-2">
